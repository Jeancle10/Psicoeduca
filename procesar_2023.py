...
# Verificar hoja 2023
if '2023' not in wb.sheetnames:
    print("ERROR: Hoja 2023 NO encontrada")
    print(f"Hojas disponibles: {wb.sheetnames}")
    exit(1)

ws = wb['2023']
print(f"Procesando hoja 2023 (Dimensiones: {ws.dimensions})\n")
...
# Mostrar resultados
print("\n" + "="*70)
print("ANÁLISIS 2023 - DESDE EXCEL")
print("="*70)
