...
# Verificar hoja 2025
if '2025' not in wb.sheetnames:
    print("ERROR: Hoja 2025 NO encontrada")
    print(f"Hojas disponibles: {wb.sheetnames}")
    exit(1)

ws = wb['2025']
print(f"Procesando hoja 2025 (Dimensiones: {ws.dimensions})\n")
...
# Mostrar resultados
print("\n" + "="*70)
print("ANÁLISIS 2025 - DESDE EXCEL")
print("="*70)
